...
public class SimpleMultiplexer<E> extends Multiplexer<E> {
    ...
    public SimpleMultiplexer(Function<String, E> itemGetter, Consumer<E> itemEnabler, Consumer<E> itemDisabler) {
