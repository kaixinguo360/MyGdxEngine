...
public class ShaderUtil {
    ...
    static {
        ...
        clearScreenShader = new ShaderProgram(
                Gdx.files.classpath("com/my/demo/builder/test/clear-screen.vertex.glsl").readString(),
                Gdx.files.classpath("com/my/demo/builder/test/clear-screen.fragment.glsl").readString()
        );
