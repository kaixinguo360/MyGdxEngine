...
public class Object3D implements Cloneable
{
	 ...
	 */
	public boolean classifyFaces(Object3D object)
	{
		...
		for(int i=0;i<getNumFaces();i++)
		{
			...
			if(!face.simpleClassify())
			{
				...
				boolean isSuccessful = face.rayTraceClassify(object); //防止死循环
				...
				if(!isSuccessful) { //防止死循环
                    MyLogger.log(3, "'rayTraceClassify' Is Not Successful, Stop 'classifyFaces'!");
					return false;
				}
			}
		}
