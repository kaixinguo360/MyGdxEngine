...
import com.my.utils.bool.util.MeshGroup;
import com.my.utils.bool.util.MyLogger;
import com.my.utils.bool.util.VertexMixer;
 ...
 */
public class ModelBoolOperation implements Cloneable
{
	 ...
	 */
	public ModelBoolOperation(ModelInstance instance,
                              MeshPart reference,
            ...
            for(MeshGroup.MyNodePart myNodePart : meshGroup.myNodeParts) {
                ...
                if(isSplit1 || isSplit2) {
                    ...
                    if(!object1.classifyFaces(object2)) {
                        throw new BooleanOperationException("Error!", myNodePart.meshPart, referenceMeshPart);
                    }

                    MyLogger.log(0, " -> 正在分类面2");
                    if(!object2.classifyFaces(object1)) {
                        throw new BooleanOperationException("Error!", referenceMeshPart, myNodePart.meshPart);
                    }
