...
import com.my.demo.builder.object.CameraBuilder;
import com.my.demo.builder.object.GroundBuilder;
import com.my.demo.builder.object.RunwayBuilder;
import com.my.demo.builder.object.TowerBuilder;
...
//        lightEntity.addComponent(new ColorAttribute(com.badlogic.gdx.graphics.g3d.attributes.ColorAttribute.Fog, new Color(0.8f, 0.8f, 0.8f, 1f)));
        ...
        Entity ground = builder.build(GroundBuilder.class);

        // ----- Init Dynamic Objects ----- //

        builder.build(RunwayBuilder.class);

        for (int i = 1; i < 5; i++) {
            for (int j = 0; j < i; j++) {
                Entity entity = builder.build(TowerBuilder.class);
        ...
        for (int x = -20; x <= 20; x+=40) {
            for (int y = 0; y <= 0; y+=20) {
                for (int z = -20; z <= 20; z+=20) {
                    ...
                    builder.build(AircraftBuilder.class, new HashMap<String, Object>() {{
        ...
        Entity aircraftEntity = builder.build(AircraftBuilder.class, new HashMap<String, Object>() {{
        ...
        builder.build(CameraBuilder.class, new HashMap<String, Object>() {{
        ...
        Entity gunEntity = builder.build(GunBuilder.class, new HashMap<String, Object>() {{
        ...
        Entity animationEntity = builder.build(AnimationBuilder.class);
