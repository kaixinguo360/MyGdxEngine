...
import com.my.utils.bool.VertexData;
...
public class MeshSplitter {
    ...
    public MeshSplitter(Mesh mesh) {
        ...
        {
            v1 = (Vertex) verticesTmp.get(indices[i]);
            v2 = (Vertex) verticesTmp.get(indices[i+1]);
            v3 = (Vertex) verticesTmp.get(indices[i+2]);
...
//        assert (vertices.contains(v2, false));
    ...
    private class Vertex {
        ...
        private Array<Vertex> cons = new Array<>();
        private int tag = -1;
...
//                ) connectVertices(this, other);
    ...
    public static Array<ModelInstance> splitModeInstances(ModelInstance instance) {
