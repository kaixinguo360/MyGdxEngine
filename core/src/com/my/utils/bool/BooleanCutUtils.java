...
import com.my.utils.bool.util.BulletUtils;
import com.my.utils.bool.util.MeshSplitter;
import com.my.utils.bool.util.MeshUtils;
...
public class BooleanCutUtils {
    ...
    public static List<Entity> cut(Entity entity, Model cutter, Matrix4 transform, Type type) throws BooleanOperationException {
        ...
        ModelInstance instance = entity.getComponent(Render.class).modelInstance.copy();
    ...
    public static Entity toEntity(Entity original, Matrix4 transform, ModelInstance instance, float mass) {
        ...
        Render render = new Render(instance);
