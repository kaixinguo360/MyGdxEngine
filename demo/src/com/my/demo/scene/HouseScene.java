...
public class HouseScene extends BaseBuilder<HouseScene> {
    ...
    public Entity build(Scene scene, Map<String, Object> params) {
        ...
        float houseLength = 120f;
        float houseWidth = 30f;
        ...
        context.subContext(null, c -> {
            ...
            c.set("楼层1.墙材质", new Material(PBRColorAttribute.createBaseColorFactor(Color.FOREST)));
            c.set("楼层2.墙材质", new Material(PBRColorAttribute.createBaseColorFactor(Color.YELLOW)));
            c.set("楼层3.墙材质", new Material(PBRColorAttribute.createBaseColorFactor(Color.PINK)));
