...
import com.my.demo.builder.object.BoxBuilder;
...
public class AnimationBuilder extends PrefabBuilder<AnimationBuilder> {

    {
        prefabName = "AnimationEntity";
    }

    public BoxBuilder boxBuilder;
    public Playable clip1;
    public Playable clip2;
    public Playable timeline1;
    ...
    public void createPrefab(Scene scene) {
        ...
        entity.addComponent(new GLTFModelInstance(boxBuilder.model));
        ...
        child1.addComponent(new GLTFModelInstance(boxBuilder.model));
        ...
        child2.addComponent(new GLTFModelInstance(boxBuilder.model));
