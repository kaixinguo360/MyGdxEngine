...
public abstract class AnimationController implements Configurable {
    ...
    public State addState(String name, String playableName) {
        ...
        State state = new State(name, playableName);
    ...
    public void update(float currentTime, float weights, Animation animation) {
        if (animation.controllerInstance == null) {
            animation.controllerInstance = new Instance(animation);
        }
    ...
    public static class State {
        ...
        public void update(float currentTime, float weights, Instance instance) {
            weights = Math.max(Math.min(weights, 1), 0);
